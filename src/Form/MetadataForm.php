...
abstract class MetadataForm extends FormBase {
	...
	public function buildMetadataForm(array $form, FormStateInterface $form_state, $selectedDataset = null, $includeSchemas = false, $includeScheduler = false, $includeOrganization = false) {
		...
		if ($includeOrganization) {
			$form['dataset_organization'] = array(
				'#type' => 'select',
				'#title' => t('Organisations :'),
				'#options' => $orgOptions,
				'#empty_option' => t('----'),
				'#required' => TRUE,
				'#default_value' => $selectedDataset != null ? $selectedOrg : '',
			);
		}
	...
	public function getDatasetOrganization(FormStateInterface $form_state) {
